...
module SwaggerClient
  ...
  class PayOptionsImport
    ...
    attr_accessor :employer_identifier
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::PayOptionsImport` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::PayOptionsImport`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'employer_identifier')
        self.employer_identifier = attributes[:'employer_identifier']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          employer_identifier == o.employer_identifier &&
    ...
    def hash
      [employer_identifier, payroll_code, pay_amount, basis, pay_code, pay_amount_multiplier, note, tags, lines].hash
    end
