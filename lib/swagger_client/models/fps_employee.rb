...
module SwaggerClient
  class FpsEmployee
    ...
    attr_accessor :employee_details
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::FpsEmployee` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::FpsEmployee`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'employee_details')
        self.employee_details = attributes[:'employee_details']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          item == o.item &&
          employee_details == o.employee_details &&
    ...
    def hash
      [employee_unique_id, item, employee_details, employment, validation_msg].hash
    end
