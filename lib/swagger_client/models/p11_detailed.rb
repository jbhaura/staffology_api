...
module SwaggerClient
  ...
  class P11Detailed
    ...
    # [readonly]
    attr_accessor :ni_and_stat_payments_lines

    attr_accessor :totals_line

    # [readonly]
    attr_accessor :ni_summary

    # [readonly]
    attr_accessor :paye_lines

    attr_accessor :paye_totals_line

    attr_accessor :paye_summary
    ...
    def self.attribute_map
      {
        ...
        :'ni_and_stat_payments_lines' => :'niAndStatPaymentsLines',
        :'totals_line' => :'totalsLine',
        :'ni_summary' => :'niSummary',
        :'paye_lines' => :'payeLines',
        :'paye_totals_line' => :'payeTotalsLine',
    ...
    def self.openapi_types
      {
        ...
        :'leave_date' => :'Object',
        :'is_director' => :'Object',
        :'ni_and_stat_payments_lines' => :'Object',
        :'totals_line' => :'Object',
        :'ni_summary' => :'Object',
        :'paye_lines' => :'Object',
        :'paye_totals_line' => :'Object',
        :'paye_summary' => :'Object',
        :'report' => :'Object',
        :'tax_year' => :'Object'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::P11Detailed` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::P11Detailed`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ni_and_stat_payments_lines')
        if (value = attributes[:'ni_and_stat_payments_lines']).is_a?(Array)
          self.ni_and_stat_payments_lines = value
        end
      end

      if attributes.key?(:'totals_line')
        self.totals_line = attributes[:'totals_line']
      end

      if attributes.key?(:'ni_summary')
        if (value = attributes[:'ni_summary']).is_a?(Array)
          self.ni_summary = value
        end
      end

      if attributes.key?(:'paye_lines')
        if (value = attributes[:'paye_lines']).is_a?(Array)
          self.paye_lines = value
        end
      end

      if attributes.key?(:'paye_totals_line')
        self.paye_totals_line = attributes[:'paye_totals_line']
      end

      if attributes.key?(:'paye_summary')
        self.paye_summary = attributes[:'paye_summary']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ni_and_stat_payments_lines == o.ni_and_stat_payments_lines &&
          totals_line == o.totals_line &&
          ni_summary == o.ni_summary &&
          paye_lines == o.paye_lines &&
          paye_totals_line == o.paye_totals_line &&
          paye_summary == o.paye_summary &&
          report == o.report &&
          tax_year == o.tax_year
    end
    ...
    def hash
      [employer_name, payroll_code, employer_office_no, employer_paye_ref, firstname, middlename, surname, ni_number, tax_code, date_of_birth, join_date, leave_date, is_director, ni_and_stat_payments_lines, totals_line, ni_summary, paye_lines, paye_totals_line, paye_summary, report, tax_year].hash
    end
